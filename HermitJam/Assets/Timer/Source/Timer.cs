...
public class Timer
{
    ...
    public bool isPermenant { get; private set; }
    ...
    public static Timer Register(float duration, Action onComplete, Action<float> onUpdate = null,
        bool isPermanent = false, bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
    {
        ...
        Timer timer = new Timer(duration, onComplete, onUpdate, isLooped, isPermanent, useRealTime, autoDestroyOwner);
    ...
    public Timer Setup(bool p_paused, bool p_completed)
    {
        this._timeElapsedBeforePause = p_paused ? null : this._timeElapsedBeforePause; 
        this.isCompleted = p_completed;
        return this;
    }
    ...
    /// <summary>
    /// Restarts a timer. Does nothing if the timer has not been paused.
    /// </summary>
    public void Restart()
    {
    ...
    private Timer(float duration, Action onComplete, Action<float> onUpdate,
        bool isLooped, bool isPermenant, bool usesRealTime, MonoBehaviour autoDestroyOwner)
    {
    ...
    private class TimerManager : MonoBehaviour
    {
        ...
        private void UpdateAllTimers()
        {
            ...
            this._timers.RemoveAll(t => t.isDone && !t.isPermenant);
        }
    }
